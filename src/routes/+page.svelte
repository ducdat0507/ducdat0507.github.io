  ...
  <div id="widgets" data-category-name="widgets" data-icon="octicon:apps-16">
    <section>
      ...
      <ul class="widget-box live-tiles">
        ...
        <!-- Internet button -->
        <li style="--col: 2; --row: 1" aria-label="the internetometer">
          <div class="center-child">
            <a href='https://internetometer.com/give/50959' style="width:95%;height:90%;" class="image-link" target="_blank" aria-label="the internetometer">
              <Tooltip>
                <p>the internetometer</p>
                <p class="tooltip-action touch-only">(click again to give an internet)</p>
              </Tooltip>
              <img src='https://internetometer.com/image/50959.png' style="width:100%;height:100%;object-fit:contain" alt="the internetometer"/>
            </a>
          </div>
        </li>
        <!-- FC2 Clap -->
